...
# Build Model
# CLEANUP(laser): Model should probably go into a function, but for now I want
# easy access to the individual layers for printing.
placeholders, feeds, vocabulary = load_data(image_features_path, text_data_path)

img_features_ph   = placeholders['img_features']
sentences_ph      = placeholders['sentences']
img_features_feed = feeds['img_features']
    ...
    for epoch in range(num_epochs):
        ...
        for a in range(0, img_count - batch_size + 1, batch_size):
            ...
            _, loss = s.run([optimizer, p],
                            feed_dict={img_features_ph: img_features_feed[a:b],
